 ...
 * Adapté pour utiliser coverImage et category selon la spec
 */
...
export default function BlogCard({ article, className, featured = false }: BlogCardProps) {
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs text-gray-500">
              ...
              {article.readingTime && (
                <div className="flex items-center gap-1.5 transition-colors duration-300 group-hover:text-purple-600">
                  ...
                  <span>{Math.round(article.readingTime)} min</span>
                </div>
              )}
              {article.author && (
